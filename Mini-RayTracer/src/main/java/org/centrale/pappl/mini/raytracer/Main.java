...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SceneObject sceneObject2 = new Sphere(new Vector3(0, 0, -1200), 50);
        ...
        //SceneObject sceneObject5 = new TriangleMeshBox(new Vector3(-700, 150, -1300), new Vector3(-100, 400, -2000), new Vector3(1, -1, 0).normalized(), new Vector3(1, 1, 0).normalized(), Scene.UZ);
        SceneObject sceneObject5 = new TriangleMeshBox(new Vector3(100, 300, -1500), new Vector3(-700, -300, -1200), new Vector3(0.87, 0, -0.5), Scene.UY, new Vector3(0.5, 0, 0.87));
        ...
        SceneObject sceneObject6 = new TriangleMeshBox(new Vector3(0,0,-1200), new Vector3(50, 50, -1150), new Vector3(1, 1, 0).normalized(), new Vector3(-1, 1, 0).normalized(), Scene.UZ);
